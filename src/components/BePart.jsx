...
import "../styles/BePart.module.css";
import styles from "../styles/BePart.module.css";
...
export default function BePart() {
  ...
  return (
    <section id="contato" className={styles.familySection}>
      <div className={styles.familyContainer}>
        <h2 className={styles.familyTitulo}>Faça Parte da Nossa Família</h2>
        ...
        <div className={styles.cardsContainer}>
          ...
          <div className={styles.card}>
            ...
            <button
              onClick={() =>
                abrirWhatsApp(
                  "Olá! Gostaria de fazer uma doação para o projeto Mãos que Acolhem."
                )
              }
            >
              Doe Agora
          ...
          <div className={styles.card}>
            ...
            <button
              onClick={() =>
                abrirWhatsApp(
                  "Olá! Tenho interesse em apadrinhar uma criança pelo projeto Mãos que Acolhem."
                )
              }
            >
              Apadrinhar
