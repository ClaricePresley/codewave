      ...
      >
        <div className="quem-text-card">
          ...
          <p className="quem-texto">
            Mãos que Acolhem é um projeto social criado no Maranhão com o
            objetivo de apoiar famílias que têm filhos com necessidades
            especiais, muitas vezes ligados a síndromes raras como microcefalia,
            paralisia cerebral e outras condições que exigem cuidado constantes.
          </p>
